...
<p align="center">
  ...
  <a href="mailto:ashubasha52@gmail.com">
    <img src="https://img.shields.io/badge/Email-ashubasha52%40gmail.com-D14836?style=for-the-badge&logo=gmail&logoColor=white" alt="Email" />
  </a>
</p>
...
| :--- | :--- | :--- | :--- |
| **🪐 Solar System 3D** | Three.js, WebGL, Web Audio API, Keplerian Astrodynamics | Photorealistic 3D Solar System & Keplerian Orrery simulation: dual Linear Alignment & Heliocentric modes, NASA telemetry, procedural shaders, sonification & voice tour. | [Live Demo](https://singularity-cinematic-universe-am.vercel.app) \| [Code](https://github.com/Mohammed-Ashraf-Shaik/singularity-cinematic-universe) |
| **🎧 SonicAM (Anything to Audio)** | FastAPI, Python, Shazamio, React Native, Expo | Advanced acoustic landmark music recognition platform: detects songs from links, media files & live mic with native Android APK. | [Live Demo](https://anything-to-audio-am.vercel.app/) \| [HF Space](https://huggingface.co/spaces/Mohammed-Ashraf-Shaik/SONICAM) \| [Code](https://github.com/Mohammed-Ashraf-Shaik/anything-to-audio) \| [Android APK](https://github.com/Mohammed-Ashraf-Shaik/anything-to-audio/releases/latest/download/SonicAM.apk) |
| **&#x1F3E5; SmartCare (AushadhiNet)** | Next.js, Vite, ES Modules, Modular CSS | Next-gen hospital operating system & Jan Aushadhi supply chain: patient queue tokens, triage, doctor workspace, and ambulance dispatch. | [Live Demo](https://smartcare-omega-two.vercel.app) \| [Vite Demo](https://smartcare-gprec.vercel.app) \| [Code](https://github.com/Mohammed-Ashraf-Shaik/smart-care-app) |
| **&#x1F4B3; Razorpay UI Clone** | HTML5, CSS3, JavaScript | Full-fidelity fintech landing page with multi-tier mega menus, 3D hero visual, and banking suites. | [Live Demo](https://mohammed-ashraf-shaik.github.io/razor/) \| [Code](https://github.com/Mohammed-Ashraf-Shaik/razor) |
| **&#x1F6D2; Flipkart Web Clone** | HTML5, CSS3, FontAwesome | Feature-rich e-commerce clone featuring product category carousel, deals grid, and responsive layout. | [Live Demo](https://mohammed-ashraf-shaik.github.io/my_1_project/) \| [Code](https://github.com/Mohammed-Ashraf-Shaik/my_1_project) |
| **&#x1F9ED; Pro Speed Tracker** | HTML5 Canvas, Geolocation API | High-precision real-time GPS speedometer & HUD with analog dial gauge and 10-language support. | [Live Demo](https://mohammed-ashraf-shaik.github.io/web2/) \| [Code](https://github.com/Mohammed-Ashraf-Shaik/web2) |
